...
<style>
	...
	#the_hint_wrap {position: absolute;top: 225px;color: #c17c22;left: 54px;width: 264px;font-weight: normal;font-family: Arial;text-align: left;font-size: 12px;overflow: hidden;max-height: 33px;}
	#the_hint_wrap div {display:inline-block;vertical-align: top;}
	#the_hint_title {padding-right:5px;}
	#the_hint {width: 200px;}
</style>
<!--[if IE]>
<style>
